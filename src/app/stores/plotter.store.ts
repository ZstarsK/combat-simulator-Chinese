...
export class PlotterStore extends BaseStore<PlotterState> {
    constructor() {
        super({
            ...
            plotTypes: [
                { key: PlotKey.XP, text: 'XP 每', isTime: true, scale: true, isRealmed: true },
                { key: PlotKey.HpXP, text: 'HP XP 每', isTime: true, scale: true, isRealmed: true },
                { key: PlotKey.PrayerXP, text: 'Prayer XP 每', isTime: true, scale: true, isRealmed: true },
                { key: PlotKey.SlayerXP, text: 'Slayer XP 每', isTime: true, scale: true, isRealmed: true },
                { key: PlotKey.SummoningXP, text: 'Summoning XP 每', isTime: true, scale: true, isRealmed: true },
                { key: PlotKey.CorruptionXP, text: 'Corruption XP 每', isTime: true, scale: true, isRealmed: false },
                {
                ...
                { key: PlotKey.AmmoUsed, text: '弹药 每', isTime: true, scale: true, isRealmed: false },
                { key: PlotKey.RunesUsed, text: '符文 每', isTime: true, scale: true, isRealmed: false },
                {
                ...
                { key: PlotKey.ConsumablesUsed, text: '消耗品 每', isTime: true, scale: true, isRealmed: false },
                { key: PlotKey.PotionsUsed, text: '药水 每', isTime: true, scale: true, isRealmed: false },
                { key: PlotKey.TabletsUsed, text: '每种类型石板 每', isTime: true, scale: true, isRealmed: false },
                { key: PlotKey.FoodUsed, text: '食物 每', isTime: true, scale: true, isRealmed: false },
                { key: PlotKey.DeathRate, text: '预计死亡率', isTime: false, scale: false, isRealmed: false },
                {
                ...
                { key: PlotKey.KillTime, text: '平均击杀时间（秒）', isTime: false, scale: false, isRealmed: false },
                { key: PlotKey.Kills, text: '击杀数 每', isTime: true, scale: true, isRealmed: false },
                { key: PlotKey.GP, text: 'GP 每', isTime: true, scale: true, isRealmed: true },
                { key: PlotKey.RawGP, text: 'Raw GP 每', isTime: true, scale: true, isRealmed: true },
                { key: PlotKey.Drops, text: '掉落 每', isTime: true, scale: true, isRealmed: false },
                { key: PlotKey.Signet, text: 'Signet Part B (%) 每', isTime: true, scale: false, isRealmed: false },
                { key: PlotKey.Pet, text: 'Pet (%) 每', isTime: true, scale: true, isRealmed: false },
                { key: PlotKey.Mark, text: 'Mark (%) 每', isTime: true, scale: true, isRealmed: false },
                { key: PlotKey.SlayerCoins, text: 'Slayer Coins 每', isTime: true, scale: true, isRealmed: true }
            ],
            timeOptions: ['击杀', '秒', '分钟', '小时', '天'],
